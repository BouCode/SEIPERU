        ...
        <div class="right_col" role="main">
                  ...
                  <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                              <div class="x_title">
                                <h2 style="text-transform: uppercase;">Galería de Videos <small></small></h2>
                                <a style="float: right;" href="editVideo.php" class="btn btn-primary">Nuevo Video</a>
                              ...
                              <div class="x_content">
                                        ...
                                        <div class="alert alert-success alert-dismissible fade in hidden" role="alert" id="alerify">
                                            ...
                                            <div class="dataTables_wrapper form-inline dt-bootstrap no-footer" id="datavideos"> 
