        ...
        $.ajax({
            ...
            success: function(resp){               
               ...
               // $('#formPaciente')[0].reset();                
                ...
                var pte = getParameterByName('pte');
                CargarPacientes(reb,pte);
                $("#alerify").removeClass("hidden");
                if(ide==""){
                   $("#pacte").text("El Paciente "+paciente.toUpperCase()+" a sido registrado correctamente.");
                }else{
                    $("#pacte").text("Los datos del Paciente "+paciente.toUpperCase()+" a sido actualizado correctamente.");
                }
