        ...
        <div class="right_col" role="main" style="background: #e8e8e8;">
                  ...
                  <div class="row">
                              <div class="col-md-offset-1 col-md-9 col-sm-12 col-xs-12 ">
                                    ...
                                    <div class="x_panel">
                                          <div class="x_title">
                                            <h2 style="text-align: center;float: none;text-transform: uppercase;font-weight: bolder;">DETALLE FORMA DE PAGO</h2>
                                            
                                            <div class="clearfix"></div>
                                          </div>
                                          <div class="x_content">
                                            <br />                                                
                                          <form class="form-horizontal form-label-left" action="Controlador/registro.php?function=insertVentas" id="frmDatosPacientes" enctype="multipart/form-data" method="POST">
                                                  <input type="hidden" class="form-control"  value="<?php echo $detProduc["idVen"] ?>" name="idVen" id="idVen"  >
                                                  <div class="form-group">
                                                        ...
                                                        <div class="col-md-9 col-sm-12 col-xs-12">
                                                                <input type="text" class="form-control" name="titulo" id="titulo" value="<?php echo $detProduc["titulo"]?>" readonly >
                                                        </div>
                                                      ...
                                                      <div class="form-group">
                                                          <label class="control-label col-md-2 col-sm-3 col-xs-12">DESCRIPCION</label>
                                                            <div class="col-md-9 col-sm-12 col-xs-12">
                                                                  <textarea class="form-control" name="texto" id="texto"><?php echo $detProduc["texto"]?></textarea>
                                                      ...
                                                      <div class="form-group">
                                                        <label class="control-label col-md-2 col-sm-3 col-xs-12">IMAGEN <span class="required" style="color: red;font-weight: bolder;font-size: 15px;">*</span></label>
