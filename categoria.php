...
if($id=="1"){
	$titule = 'Herramientas Eléctricas';
	
}else if($id=="2"){
	$titule = 'Herramientas Manuales';

}else if($id=="3"){
	$titule = 'Electrodomésticos y Gasodomésticos';
	
}else if($id=="4"){
	$titule = 'Tecnología';
	
}else if($id=="5"){
	$titule = 'Energía y Medio Ambiente';
	
}else if($id=="6"){
	$titule = 'Equipos de Protección Personal';

}else if($id=="7"){
	$titule = 'Limpieza y Hogar';
							...
							<ul class="pagination">
																		...
																		<?php
																							if ($total_registros) {
																								...
																								if (($pagina - 1) > 0) {
																									echo "<li ><a style='background: white;' href='categoria.php?id=".$id."&pagina=".($pagina-1)."'>< Anterior</a></li>";
																									} else {
																								...
																								for ($i = 1; $i <= $total_paginas; $i++) {
																									if ($pagina == $i) {
																										...
																										echo "<li ><a style='background: white;' href='categoria.php?id=".$id."&pagina=$i'>$i</a> </li>"; 
																									} 
																								}
																								if (($pagina + 1)<=$total_paginas) {
																									echo "<li ><a style='background: white;' href='categoria.php?id=".$id."&pagina=".($pagina+1)."'>Siguiente ></a></li>";
																								} else {
